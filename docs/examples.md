...
The example tree is organized by how people usually use the project:
...
The root `examples/demo-bundle.json` remains the default starter bundle used by the README and the app.
